<button
    ...
    title="{{ __('messages.pause_dashboard_motion') }}"
    hidden
>
    <svg class="motion-pause-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path d="M9 6v12M15 6v12" />
    </svg>
    <svg class="motion-play-icon" viewBox="0 0 24 24" aria-hidden="true">
