...
<nav class="menu">
    ...
    @if(auth()->user()->role == 'super_admin')
        ...
        <a href="/external-invoices" class="{{ request()->is('external-invoices*') ? 'active' : '' }}"><svg class="icon" viewBox="0 0 24 24"><path d="M6 2h9l3 3v17H6z"/><path d="M14 2v5h4M9 12h6M9 16h6"/></svg> {{ __('messages.external_invoices') }}</a>
