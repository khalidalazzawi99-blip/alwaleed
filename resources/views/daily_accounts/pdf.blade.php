...
.brand-line { width: 46px; height: 4px; margin: 0 0 9px auto; background: #c8a878; border-radius: 4px; }
.company { margin: 0 0 3px; color: #a17f50; font-size: 11px; font-weight: 700; }
h1 { margin: 0; color: #17233a; font-size: 24px; font-weight: 700; }
.subtitle { margin-top: 5px; color: #7d8797; font-size: 9px; }
.logo-cell { width: 36%; text-align: left; }
.logo { max-width: 115px; max-height: 58px; }
.logo-fallback { display: inline-block; padding: 12px 18px; border: 1px solid #dfe4eb; border-radius: 8px; color: #a17f50; font-size: 14px; font-weight: 700; }
.report-meta { width: 100%; border-collapse: separate; border-spacing: 0; margin-bottom: 13px; background: #192944; border: 1px solid #192944; border-radius: 8px; }
.report-meta td { padding: 11px 14px; border: 0; color: #dce2ec; text-align: right; }
.report-meta .label { color: #d5bb92; font-weight: 700; }
...
.summary td { width: 20%; height: 62px; padding: 9px 10px; vertical-align: top; background: #fbfcfe; border: 1px solid #dfe4eb; border-radius: 7px; text-align: right; }
.summary td.primary { background: #192944; border-color: #192944; color: #fff; }
.summary .title { display: block; margin-bottom: 7px; color: #7d8797; font-size: 8px; font-weight: 500; }
.summary .primary .title { color: #f6eee4; }
.summary strong { display: block; color: #17233a; font-size: 14px; line-height: 1.35; direction: ltr; unicode-bidi: embed; text-align: right; font-weight: 700; }
...
.section-title { margin: 0 0 7px; padding-right: 8px; border-right: 3px solid #c8a878; color: #17233a; font-size: 12px; font-weight: 700; }
